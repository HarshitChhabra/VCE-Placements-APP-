...
public class FacultyCompanyAdapter<T> extends ArrayAdapter<T> {
    Context context;
    ArrayList arrayList;
    ...
    public FacultyCompanyAdapter(Context context, ArrayList<T> arrayList){
...
//        return 0;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        FacultyCompanyAdapter.ViewHolder holder=new FacultyCompanyAdapter.ViewHolder();
        ...
        if(convertView==null){
            ...
            //UNCOMMENT BELOW
            convertView=LayoutInflater.from(context).inflate(R.layout.faculty_company_item,null,false);
...
//            holder.date=(TextView) convertView.findViewById(R.id.date);
            ...
            holder.companyName=(TextView) convertView.findViewById(R.id.facultyCompanyName);
            holder.removeBtn=(Button) convertView.findViewById(R.id.removeBtn);

            convertView.setTag(holder);
        }
        else{
            holder=(FacultyCompanyAdapter.ViewHolder)convertView.getTag();
        }

        //Get Each Item. RowItem is the class (java) which defines each list item

        //UNCOMMENT BELOW
        final String compname= (String) arrayList.get(position);

        final Button removebtn=holder.removeBtn;
...
//        holder.date.setText(circular.getDate());
        ...
        holder.companyName.setText(compname);
        holder.companyName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(context,FacultyAppliedSelected.class);
            ...
            holder.removeBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    builder.setMessage("Do you want to remove " + compname + " from the Drive?");
                    ...
                    builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            FirebaseDatabase.getInstance().getReference("HR").child(compname).removeValue();

                            arrayList.remove(compname);
